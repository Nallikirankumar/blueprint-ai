const API_URL = "https://blueprint-ai-38pr.onrender.com/api/generate-blueprint";
...
function updateStatistics(blueprint) {
    ...
    const totalAvailableArea =
        projectStatistics.total_available_area ??
        blueprint.plot.area;
    ...
    console.log(
        "Plot area per floor:",
        projectStatistics.plot_area_per_floor ??
        blueprint.plot.area
    );
    ...
    console.log(
        ...
        projectStatistics.recommended_usable_area ??
        "Not available"
    );

    console.log(
        "Estimated required area:",
        projectStatistics.estimated_required_area ??
        "Not available"
    );

    console.log(
        "Remaining area:",
        projectStatistics.remaining_area ??
        "Not available"
    );

    console.log(
        "Space utilisation:",
        projectStatistics.space_utilisation !== undefined
            ? `${projectStatistics.space_utilisation}%`
            : "Not available"
    );
}
    document.getElementById(
